...
In the quest to design algorithms for real-time generative art, there are many dangers to avoid. One of the biggest dangers is what is known as **the complexity class**.
