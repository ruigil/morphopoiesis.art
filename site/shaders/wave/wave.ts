        ...
        return { 
            ...
            uniforms: () => ({
                uni: {
                    ...
                    amplitude: 20,
                    osc: [ 
                        { amplitude: 3, frequency: 11, position: [size.x/2 ,size.y/2 + 100] },
                        { amplitude: 1, frequency: 7, position: [size.x/2 - 100,size.y/2 - 70] },
                        { amplitude: 2, frequency: 5, position: [size.x/2 + 100,size.y/2 - 70] }
                    ]
                }
            }),
            storages: [
